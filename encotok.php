...
<html>
	...
	{
		$reponse = $bdd->prepare('INSERT INTO instants(jour, debut, fin, montant, idAdh) VALUES(?, ?, ?, ?, ?)');
		$reponse->execute(array($_POST['jour'], $_POST['debut'], $_POST['fin'], $_POST['mont'], $_POST['ida']));
		echo '<script>alert("La cotisation a bien été enregistrée!");</script>';
	}
	else
	{
